...
const CreateCashier = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      await axios.post('/manager/create-user', formData)
      toast.success('Cashier created successfully! Welcome email sent.')
      setFormData({
        firstName: '',
        lastName: '',
        email: '',
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Create Cashier</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <p className="text-sm text-blue-800 dark:text-blue-200">
              📧 A welcome email with login credentials will be sent to the cashier's email address.
            </p>
          </div>
